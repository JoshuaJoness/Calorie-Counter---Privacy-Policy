...
This is an open source app developed by Joshua Jones. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
